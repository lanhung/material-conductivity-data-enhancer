-- Hive/Spark external tables for data-generator-base-rule
-- Source of truth: data-generator-base-rule/src/main/java/com/lanhung/conductivity/DataGeneratorBaseRuleApp.java
-- Default database: ods_zirconia_rule_based
-- Default output root: ./output

CREATE DATABASE IF NOT EXISTS ods_zirconia_rule_based;

USE ods_zirconia_rule_based;
...
USING parquet
LOCATION './output/ods_zirconia_rule_based/crystal_structure_dict';

INSERT OVERWRITE crystal_structure_dict VALUES
    (1, 'c', 'Cubic'),
    (2, 't', 'Tetragonal'),
    (3, 'm', 'Monoclinic'),
    (4, 'o', 'Orthogonal'),
...
USING parquet
LOCATION './output/ods_zirconia_rule_based/synthesis_method_dict';

INSERT OVERWRITE synthesis_method_dict VALUES
    (1, '/'),
    (2, 'Commercialization'),
    (3, 'Coprecipitation'),
...
USING parquet
LOCATION './output/ods_zirconia_rule_based/processing_route_dict';

INSERT OVERWRITE processing_route_dict VALUES
    (1, '/'),
    (2, '3D printing'),
...
USING parquet
LOCATION './output/ods_zirconia_rule_based/material_samples';
...
USING parquet
LOCATION './output/ods_zirconia_rule_based/sample_dopants';
...
USING parquet
LOCATION './output/ods_zirconia_rule_based/sintering_steps';
...
USING parquet
LOCATION './output/ods_zirconia_rule_based/sample_crystal_phases';
